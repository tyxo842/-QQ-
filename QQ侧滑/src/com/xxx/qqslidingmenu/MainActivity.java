...
import com.xxx.qqslidingmenu.bean.Cheeses;
import com.xxx.qqslidingmenu.utils.ToastUtil;
import com.xxx.qqslidingmenu.view.DragLayout;
import com.xxx.qqslidingmenu.view.DragLayout.OnDragStateChangeListener;
import com.xxx.qqslidingmenu.view.InnerLinearLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDl.setOnDragStateChangeListener(new OnDragStateChangeListener() {
			...
			public void onDragging(float percent) {
				ToastUtil.showToast(getApplicationContext(), "percent:"
						+ percent);
			...
			public void onClose() {
				...
				ObjectAnimator animator = ObjectAnimator.ofFloat(mIvHead,
						"translationX", 15f);
